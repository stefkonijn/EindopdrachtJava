...
@XmlType(name = "Product", namespace = "http://schemas.datacontract.org/2004/07/StoreWebservice", propOrder = {
    "id",
    "name",
    "orders",
    "price",
...
public class Product {
    ...
    @XmlElementRef(name = "Name", namespace = "http://schemas.datacontract.org/2004/07/StoreWebservice", type = JAXBElement.class, required = false)
	...
	public String toString() {
		return name.getValue()+", €"+ price +", "+ stock;
	}
